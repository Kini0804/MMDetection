...
train_dataset = dict(
    ...
    dataset=dict(
        type='VOCDataset',
        ann_file='data/HRSC2016/VOC2007/ImageSets/HRSC/trainval.txt',
        img_prefix='data/HRSC2016/VOC2007/',
        pipeline=[
...
data = dict(
    ...
    val=dict(
        type='VOCDataset',
        ann_file='data/HRSC2016/VOC2007/ImageSets/HRSC/test.txt',
        img_prefix='data/HRSC2016/VOC2007/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
work_dir = './work_dirs/yolof_x_csp_HRSC_lr001'
auto_resume = False
gpu_ids = [0]