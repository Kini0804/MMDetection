...
#     dataset=dict(
#         type='VOCDataset',
#         ann_file='data/SeaShips/VOC2007/ImageSets/Main/trainval.txt',
#         img_prefix='data/SeaShips/VOC2007/',
#         pipeline=[
...
#     val=dict(
#         type='VOCDataset',
#         ann_file='data/SeaShips/VOC2007/ImageSets/Main/test.txt',
#         img_prefix='data/SeaShips/VOC2007/',
#         pipeline=[
#             dict(type='LoadImageFromFile'),
#             dict(
...
work_dir = './work_dirs/my_yolov5_change_lr_optimizer_hook'
auto_resume = False
gpu_ids = [0]
